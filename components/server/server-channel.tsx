...
import { ActionTooltip } from "../action-tooptip";
...
export const ServerChannel = ({
    ...
    return (
        <button
            onClick={() => { }}
            className={cn(
                "group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:big-zinc-700/50 transition mb-1",
                // If this channel is selected, highlight the channel
